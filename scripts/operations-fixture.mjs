export const fixture = {
  ...
  items:[{id:'i1',command_id:'cmd1',professional_id:'p1',description:'Corte integrado',unit_price_cents:4000,quantity:1,commission_cents:1600},{id:'i2',command_id:'cmd2',professional_id:'p2',description:'Corte integrado',unit_price_cents:4000,quantity:1,commission_cents:0}],
