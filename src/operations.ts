...
export type PackageRedemption = { id: string; sale_id: string; service_id: string; command_item_id: string; package_name: string; redeemed_at: string }
...
export type Operations = { appointments: Appointment[]; blocks: ScheduleBlock[]; customers: Customer[]; commands: Command[]; items: Item[]; payments: Payment[]; commissions: Commission[]; sessions: CashSession[]; movements: Movement[]; products: Product[]; packages: ServicePackage[]; packageSales: PackageSale[]; packageRedemptions: PackageRedemption[]; business: BusinessSettings[] }
export const emptyOperations: Operations = { appointments: [], blocks: [], customers: [], commands: [], items: [], payments: [], commissions: [], sessions: [], movements: [], products: [], packages: [], packageSales: [], packageRedemptions: [], business: [] }
